...
MODULES              = rt_matrx.c rt_printf.c rt_logging.c PV_Array_Model.c PV_Array_Model_capi.c PV_Array_Model_data.c PV_Array_Model_tgtconn.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_discreteVariableDelay.c
PRODUCT              = PV_Array_Model.exe
MAKEFILE             = PV_Array_Model.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/User/Downloads/Solar
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = PV_Array_Model_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/PV_Array_Model \
...
rtiostream_utils.obj : C:/Program\ Files/MATLAB/R2020a/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:/Program\ Files/MATLAB/R2020a/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c

sfun_discreteVariableDelay.obj : C:/Program\ Files/MATLAB/R2020a/toolbox/physmod/powersys/powersys/sfun_discreteVariableDelay.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:/Program\ Files/MATLAB/R2020a/toolbox/physmod/powersys/powersys/sfun_discreteVariableDelay.c
